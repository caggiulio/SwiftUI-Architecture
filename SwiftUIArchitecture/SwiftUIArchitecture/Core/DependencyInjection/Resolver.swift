...
@MainActor public protocol ResolverRegistering {
...
@MainActor private var registrationNeeded: Bool = true
...
public struct ResolverOptions<Service> {
  ...
  @MainActor @discardableResult
    ...
    ///
    @discardableResult
  @MainActor public func resolveProperties(_ block: @escaping ResolverFactoryMutator<Service>) -> ResolverOptions<Service> {
    ...
    ///
    @discardableResult
  @MainActor public func resolveProperties(_ block: @escaping ResolverFactoryMutatorArgumentsN<Service>) -> ResolverOptions<Service> {
        registration.update { existingFactory in
            return { (resolver, args) in
                guard let service = existingFactory(resolver, args) else {
                    return nil
    ...
    ///
    @discardableResult
  @MainActor public func scope(_ scope: ResolverScope) -> ResolverOptions<Service> {
...
@MainActor public final class ResolverRegistration<Service> {
...
@MainActor public protocol ResolverScopeType: AnyObject {
    func resolve<Service>(registration: ResolverRegistration<Service>, resolver: Resolver, args: Any?) -> Service?
    func reset()
}

@MainActor public class ResolverScope: ResolverScopeType {
...
public final class ResolverScopeContainer: ResolverScope {
  ...
  @MainActor public override final func resolve<Service>(registration: ResolverRegistration<Service>, resolver: Resolver, args: Any?) -> Service? {
...
///
@MainActor @propertyWrapper public struct Injected<Service> {
...
///
@MainActor @propertyWrapper public struct OptionalInjected<Service> {
    private var service: Service?
    public init() {
...
///
@MainActor @propertyWrapper public struct LazyInjected<Service> {
...
/// Wrapped dependent service is not resolved until service is accessed.
///
@MainActor @propertyWrapper public struct WeakLazyInjected<Service> {
    private var lock = Resolver.lock
    private var initialize: Bool = true
